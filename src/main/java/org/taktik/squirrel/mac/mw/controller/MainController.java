...
public class MainController {
	...
	public @ResponseBody
	UpdateResponse check(@PathVariable("groupId") String groupId, @PathVariable("artifactId") String artifactId, @RequestParam("version") String version,
						 HttpServletRequest request,
						 HttpServletResponse response) throws NoContentAvailableException {
